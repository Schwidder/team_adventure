...
Leerzeichen - Freie Felder
$ - Spieler Spawnposition
o - spawnt eine Münze
= - spawnt einen horizontal bewegenden Lavablock (Horizontale Lava mit Kollision )
| - spawnt einen vertikal bewegenden Lavablock   (Vertikale Lava mit Kollision) 
v - spawnt einen fallenden Lavablock der beim berühren des Bodens neu spawnt
...
// Hier werden die für die Level benötigten Objekte definiert / initialisiert.
var actorChars = {
  "@": Player,
  "o": Coin,
  "=": Lava,
...
// Hier entsteht das Level (Array) mit der Verwendung, der oben genannten Objekten.
var levelPlans = [[
	"                                                                                ",
	"                                                                                ",
	"                                                                                ",
...
// Definiert die FOV (Field of view) vom Spiel -->desto kleiner desto mehr von der Map zu sehen
var scale = 20;

// Definiert die Bewegungsgeschw. der Muenze
var wobbleSpeed = 8, wobbleDist = 0.07;

// Definiert die horizontale Geschwindigkeit des Spielers
var playerXSpeed = 7;

// Definiert die vertikale Sprunggeschw. des Spielers (Gravitation)
var gravity = 30;
var jumpSpeed = 17;

// Definiert die Steuerung
var arrowCodes = {37: "left", 38: "up", 39: "right"};

// Wartet auf den Browser und führt danach das Script aus.
...
// Das level wird erstellt und das Spiel gestartet
ready(function() {
  runGame(levelPlans, DOMDisplay);
});

//Level wird gelesen (spalten, zeilen) und die höhe und breite des Spiel's erstellt
...
// Bestimmt ob der Block ein Objekt überlappt (es werden die Leerenfelder nicht berücksicht
...
Level.prototype.obstacleAt = function(pos, size) {
  ...
  if (xStart < 0 || xEnd > this.width || yStart < 0)
    return "wall";
  if (yEnd > this.height)
    return "lava"; // Wenn der Spieler aus der Welt fällt wird das Spiel zurückgesetzt (genau so als ob er Lava berührt)
...
// Speicher für die Position und Größe des Objektes.
function Vector(x, y) {
  this.x = x;
  this.y = y;
}
